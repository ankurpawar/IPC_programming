/**
 *
 *client that calculates subtraction
 */
...
#include<fcntl.h>
#include"data.h"
#define OP_FIFO_NAME "/tmp/my_co1"
#define RES_FIFO_NAME "/tmp/my_cr1"
int main()
{
	...
	printf("subtract d.op1=%d,d.op2=%d,d.ops=%c\n",d.op1,d.op2,d.ops);
	res = d.op1 - d.op2;
	printf("subtarct result = %d\n",res);
